...
public class VehicleDAO {
	...
	public void insertVehicle(AddVehicle obj) throws Exception
	{
		...
		PreparedStatement ps= c.prepareStatement("insert into addVehicle(regNo,brand,maxVelocity,capacity,vehicleType,cost,vehicleTax) values(?,?,?,?,?,?,?)");
	...
	while(rs.next())
{
		res.add(new AddVehicle(rs.getInt(1),rs.getString(2),rs.getString(3),rs.getInt(4),rs.getInt(5),rs.getString(6),rs.getInt(7),rs.getDouble(8)));
	}
